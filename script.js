...
class Link {
  ...
  // Initial links array
  const links = [];
  links.push(new Link("Hachiu", "https://nhacospe.com", "snnse"));
  links.push(new Link("Reddit", "https://reddit.com", "Thai"));
  links.push(new Link("Boring Boring", "google.net", "Daniel"));
